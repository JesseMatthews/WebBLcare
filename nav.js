  ...
  <div class="container">
    <div class="footer-grid">
      ...
      <div class="footer-col">
        ...
        <ul class="footer-links">
          ...
          <li><span aria-label="Service area">Area: Lancashire (Preston, Lytham, Fleetwood and Blackpool)</span></li>
    ...
    <div class="footer-bottom">
      ...
      <div class="footer-certs">
        <!-- CQC: Replace YOUR_CQC_PROVIDER_ID below, then delete this comment and the two surrounding comment tags to activate -->
        <!-- <a class="cert-badge" href="https://www.cqc.org.uk/provider/YOUR_CQC_PROVIDER_ID" target="_blank" rel="noopener">CQC Registered</a> -->
...
const HOURS_NOTICE_HTML = `<div id="hoursNotice" class="hours-notice" role="status" aria-live="polite" hidden><button id="closeHoursNotice" class="hours-notice-close" aria-label="Close notice">×</button><span id="hoursNoticeText"></span></div>`;
const OFFICE_HOURS = [
  null,
  { open: 8, close: 18 },
  { open: 8, close: 18 },
...
function updateHoursNotice() {
  if(sessionStorage.getItem('hoursNoticeDismissed')==='1') return;
  ...
  if (isOfficeOpen()) {
    ...
    const txtEl=document.getElementById('hoursNoticeText'); if(txtEl){txtEl.textContent=getClosedNotice();}
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (headerSlot) {
    ...
    updateHoursNotice();
    document.addEventListener('click',e=>{if(e.target&&e.target.id==='closeHoursNotice'){sessionStorage.setItem('hoursNoticeDismissed','1');document.getElementById('hoursNotice').hidden=true;document.body.classList.remove('hours-notice-visible');}});
  }
